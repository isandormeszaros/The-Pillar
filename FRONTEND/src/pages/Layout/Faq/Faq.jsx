        ...
        <div className="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
          <nav aria-label="breadcrumb">
            <ol className="breadcrumb">
              <li className="breadcrumb-item "><a href="/home" className="text-decoration-none text-white">Home</a></li>
              <li className="breadcrumb-item "><a href="/home" className="text-decoration-none text-white">Szolgáltatlások</a></li>
              <li className="breadcrumb-item"><a href="/faq" className="text-decoration-none text-white">GYAK</a></li>
            </ol>
          </nav>
          ...
          <div className="faq-container container custom-p-font text-start">
            ...
            <div className="container justify-content-center align-items-center">
              <div className="accordion accordion-flush col-lg-8" id="accordionFlushExample">
